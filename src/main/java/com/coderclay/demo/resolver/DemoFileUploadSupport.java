 ...
 * @see DemoMultipartResolver
 * @since 2.0
 */
public abstract class DemoFileUploadSupport {

    protected final Log logger = LogFactory.getLog(getClass());

    private final DiskFileItemFactory fileItemFactory;

    private final DemoFileUpload fileUpload;
     ...
     */
    public DemoFileUpload getFileUpload() {
     ...
     */
    protected abstract DemoFileUpload newFileUpload(FileItemFactory fileItemFactory);
     ...
     */
    protected DemoFileUpload prepareFileUpload(@Nullable String encoding) {
        DemoFileUpload fileUpload = getFileUpload();
        DemoFileUpload actualFileUpload = fileUpload;
